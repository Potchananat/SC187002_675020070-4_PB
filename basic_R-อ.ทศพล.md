...
```
    ...
    ## Warning in mean.default(mean): argument is not numeric or logical: returning NA
...
``` r
grade_2 <- factor(grade_vector, level = c("A", "B", "c", "D", "F"))
grade_1
```
...
![](basic_R-อ.ทศพล_files/figure-gfm/unnamed-chunk-29-1.png)<!-- -->
...
![](basic_R-อ.ทศพล_files/figure-gfm/unnamed-chunk-30-1.png)<!-- -->
...
![](basic_R-อ.ทศพล_files/figure-gfm/unnamed-chunk-31-1.png)<!-- -->
...
![](basic_R-อ.ทศพล_files/figure-gfm/unnamed-chunk-32-1.png)<!-- -->
...
![](basic_R-อ.ทศพล_files/figure-gfm/unnamed-chunk-34-1.png)<!-- -->
...
![](basic_R-อ.ทศพล_files/figure-gfm/unnamed-chunk-36-1.png)<!-- -->
...
![](basic_R-อ.ทศพล_files/figure-gfm/unnamed-chunk-37-1.png)<!-- -->
